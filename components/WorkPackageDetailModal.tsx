...
export const WorkPackageDetailModal: React.FC<WorkPackageDetailModalProps> = ({ workPackage, onClose, teamMembers }) => {
      ...
      >
        ...
        <main className="p-6">
            <dl className="space-y-4">
                <DetailRow label={t('project')} value={workPackage.projectId || 'N/A'} />
                <DetailRow label={t('title')} value={workPackage.title} />
                <DetailRow label={t('responsible')} value={responsibleName} />
                {workPackage.priority && <DetailRow label={t('priority')} value={workPackage.priority} />}
